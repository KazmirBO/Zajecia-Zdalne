...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # self.label_netprice.setStyleSheet(
        ...
        self.doubleSpinBox_discount = QtWidgets.QDoubleSpinBox(
            self.centralwidget)
        self.doubleSpinBox_discount.setGeometry(
            QtCore.QRect(260, 160, 421, 41))
