...
int main(int argc, char const *argv[]) {
  ...
  std::cout << "Babelkowe: Opt: O(n^2)    , Typ: O(n^2)    , Pes: O(n^2),"
            << std::endl;
  std::cout << "Merge    : Opt: O(n*log n), Typ: O(n*log n), Pes: O(n*log n),"
            << std::endl;
  std::cout << "Quick    : Opt: O(n*log n), Typ: O(n*log n), Pes: O(n^2),"
            << std::endl;
  std::cout << "Insertion: Opt: O(n)      , Typ: O(n^2)    , Pes: O(n^2),"
            << std::endl;
  std::cout << "Select   : Opt: O(n^2)    , Typ: O(n^2)    , Pes: O(n^2),"
            << std::endl;
  std::cout << "Shaker   : Opt: O(n)      , Typ: O(n^2)    , Pes: O(n^2),"
            << std::endl;
  std::cout << "Dumb     : Opt: O(n^2)    , Typ: O(n^3)    , Pes: O(n^3),"
            << std::endl;
  std::cout << std::endl;
  return 0;
}
