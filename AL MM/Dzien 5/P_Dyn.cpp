...
int main() {
  while (true) {
    ...
    if (wybor == 1 || wybor == 2) {
      ...
      switch (wybor) {
      case 1:
        tab1 = new int[WIELKOSC_TAB]{50000, 20000, 10000, 5000, 2000, 1000,
                                     500,   200,   100,   50,   20,   10,
                                     5,     2,     1}; // zloty w groszach
        break;

      case 2:
        tab1 = new int[WIELKOSC_TAB]{
            100000, 20000, 10000, 5000, 2000, 1000, 500,
            200,    100,   50,    25,   10,   5,    1}; // dolar w centach
        break;
      }
